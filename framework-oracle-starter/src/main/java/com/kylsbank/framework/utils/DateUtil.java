                ...
                if (0 < queryList.size()) {
                    ...
                    if(StringUtils.isNotBlank(startTimeStr)) {
                        ...
                        if (StringUtils.isBlank(prefix)) {
                            params.put("startTime", DateUtil.format(startTime, dateTypeEnum.getPatternType().getPattern()));
                        } else {
                            params.put(prefix + "StartTime", DateUtil.format(startTime, dateTypeEnum.getPatternType().getPattern()));
                        }
                    }
                }
                if (1 < queryList.size()) {
                    ...
                    if(StringUtils.isNotBlank(endTimeStr)) {
                        ...
                        if (StringUtils.isBlank(prefix)) {
                            params.put("endTime", DateUtil.format(cal.getTime(), dateTypeEnum.getPatternType().getPattern()));
                        } else {
                            params.put(prefix + "EndTime", DateUtil.format(cal.getTime(), dateTypeEnum.getPatternType().getPattern()));
                        }
                    }
                }
            }
