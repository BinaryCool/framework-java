 ...
 * 
 */
package pers.binaryhunter.db.mybatis.shardbatis.builder;
...
import pers.binaryhunter.db.mybatis.shardbatis.strategy.ShardStrategy;
...
public class ShardConfigParser {
	...
	private static final String SHARD_CONFIG_DTD = "META-INF/shardbatis-config.dtd";
